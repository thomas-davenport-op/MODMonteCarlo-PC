...
def run_mc_program(mc_program, output_directory, temp_card_file):
	...
	if mc_program == "pythia":
		call( [ 'bin/generateEvents', temp_card_file, '{}/pythia/{}'.format(output_directory, filename) ] )
	elif mc_program == "herwig":
...
def process_mc(mc_program, output_directory):
	...
	if mc_program == "pythia":
		header = "Pythia_8215"
		card_file = "pythia_card.cmnd"
	elif mc_program == "herwig":
		header = "Herwig_7"
		card_file = "herwig_card.in"
	elif mc_program == "sherpa":
		header = "Sherpa_220"
	...
	temp_card_file = './tmp/' + card_file

	print
	print "======================== MOD Monte Carlo ========================"
	print
	print "I've been asked to generating {} events using {}.".format(total_number_of_events, mc_program.capitalize())
